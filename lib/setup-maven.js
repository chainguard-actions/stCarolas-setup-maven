...
var require_tool_cache = __commonJS({
  "node_modules/@actions/tool-cache/lib/tool-cache.js"(exports2) {
    ...
    var os = __importStar2(require("os"));
    var path = __importStar2(require("path"));
    var httpm = __importStar2(require_http_client());
    ...
    function _createToolPath(tool, version2, arch) {
      return __awaiter2(this, void 0, void 0, function* () {
        const folderPath = path.join(cacheRoot, tool, semver.clean(version2) || version2, arch || "");
...
var require_installer = __commonJS({
  "lib/installer.js"(exports2) {
    ...
    function getMaven(version2) {
      return __awaiter2(this, void 0, void 0, function* () {
        let toolPath;
        toolPath = tc.find("maven", version2);
        if (!toolPath) {
          toolPath = yield downloadMaven(version2);
        }
        toolPath = path.join(toolPath, "bin");
        core2.addPath(toolPath);
      });
    }
    exports2.getMaven = getMaven;
    function downloadMaven(version2) {
      return __awaiter2(this, void 0, void 0, function* () {
        const toolDirectoryName = `apache-maven-${version2}`;
        const downloadUrl = `https://repo.maven.apache.org/maven2/org/apache/maven/apache-maven/${version2}/apache-maven-${version2}-bin.tar.gz`;
        ...
        try {
          ...
          return yield tc.cacheDir(toolRoot, "maven", version2);
        } catch (err) {
          throw err;
        }
      });
...
var installer = __importStar(require_installer());
function run() {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      let version2 = core.getInput("maven-version");
      if (version2) {
        yield installer.getMaven(version2);
      }
    } catch (error) {
